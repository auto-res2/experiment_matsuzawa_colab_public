...
% map the Unicode minus (U+2212) to a normal hyphen/minus so the file
% compiles even if such characters sneak in.
...
\begin{itemize}
    ...
    \item \textbf{Metrics} FID-50k, Inception Score, CLIP-Score, LPIPS, latency measured by CUDA events, GPU energy via \texttt{pynvml}.
